...
/*
 *	Setup the basic definitions for Windows/CE
 */
#ifndef	_WIN32_WCE
#error	"Apparently, not compiling for Windows/CE"
#endif	/* not _WIN32_WCE */

#define	MS_WINCE		/* Compiling for Windows/CE */
#include <windows.h>		/* Get this out of the way in a controlled fashion */
#ifdef	finally
#undef	finally			/* Fix this define that comes out of <excpt.h> */
#endif	/* finally */
