...
/* MS_WINDOWS || __CYGWIN__ */
	...
	{
		WCHAR Temp[MAX_PATH];
		_WinCE_Absolute_Path_To_WCHAR(buf, Temp, sizeof(Temp)/sizeof(Temp[0]));
		h = FindFirstFile(Temp, &data);
		if (h != INVALID_HANDLE_VALUE) {
			WideCharToMultiByte(CP_ACP, 0, data.cFileName, -1, (char *)Temp, sizeof(Temp), NULL, NULL);
			strcpy((char *)data.cFileName, (char *)Temp);
		}
	}
#else
	...
	FindClose(h);
	return strncmp((char *)data.cFileName, name, namelen) == 0;
